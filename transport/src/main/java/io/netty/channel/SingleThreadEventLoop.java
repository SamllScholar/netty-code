...
public abstract class SingleThreadEventLoop extends SingleThreadEventExecutor implements EventLoop {
    ...
    @Override
    public EventLoop next() {//给ServerSocketChannel 从boss group中选择一个NioEventLoop
        return (EventLoop) super.next();
    }

    @Override
    public ChannelFuture register(Channel channel) {//给ServerSocketChannel 从boss group中选择一个NioEventLoop
    ...
    protected boolean hasTasks() {
        // 判断当前的任务队列和负任务队列中是否有任务, 只要有一个有那么就代表当前有任务需要执行
